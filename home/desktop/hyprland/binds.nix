...
in {
  ...
  bind =
    [
      ...
      (bind "SUPER + S" ''hl.dsp.exec_cmd([[hyprshot -m region -z --clipboard-only --slurp-args "-w 0"]])'')
      (bind "SUPER + SHIFT + S" ''hl.dsp.exec_cmd([[hyprshot -m window -z --clipboard-only --slurp-args "-w 0"]])'')
      (bind "Print" ''hl.dsp.exec_cmd([[hyprshot -m region -z --clipboard-only --slurp-args "-w 0"]])'')
      (bind "SUPER + Print" ''hl.dsp.exec_cmd([[hyprshot -m window -z --clipboard-only --slurp-args "-w 0"]])'')
